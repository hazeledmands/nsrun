...
describe('Positionned arguments' ,function(){
    ...
    it('runs the scripts you define in package.json with $* arguments', function (done) {
        ...
        .stdout('Monkeys dreams of flowers trees grasses and no ice creams, sometimes')
        .stderr('')
        .code(0)
        .end(done);
    });
    ...
    it('runs the scripts you define in package.json with few arguments', function (done) {
        nixt()
        .run('./nsrun.js more-monkeys-dreams flowers trees sleeps for an ice creams')
        .stdout('Monkeys dreams 2 things : trees and flowers, sometimes it sleeps for an ice creams')
        .stderr('')
        .code(0)
        .end(done);
    });
